...
nalaze podaci koji, vjerojatno, nisu pripremljeni za korištenje za 
...
koji mogu izazvati nedefinirano ponašanje programa. Ranjivost				% Ovo se pise zajedno! Vec sam vas upozorio na te pogreske i da ih popravite po cijelom tekstu! -Ispravljeno
...
spriječava izvršavanje ubačenog programskog koda. Ukoliko je DEP				% sprjecava ili sprIjecava? Dajte koristite hashek (ili kako se zove) i provjerite pravopis -popravljeno
...
virtualnog adresnog prostora u sustavu. Također, valja napomenuti kako svaki proces
...
traženoj veličini uvećanoj za veličinu zaglavlja.				% Meko c!
...
se koristi u ovom radu. Moguće		% ... osim C/C++ koji se koristi u ovom radu.
