...
%\pagebreak										% U LaTeX-u se rijetko ubacuju prijelomi stranica! -Izbacio sam sih
...
strukture prikazan je na ispisu \ref{lst:imgSectionHeader}.				% Rekao sam da SVUDA promijenite ``odsjecak'' u ispis! -promijenjeno
...
Kao što je vidljivo na ispisu \ref{lst:PE_instructions}, postoje dvije instrukcije
...
i nalazi se u posljednjem, 21. redu ispisa 
